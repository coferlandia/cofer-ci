...
Este procedimiento parte de una VM sin una instalación previa de Coferlandia CI. No es un manual de actualización. Para instalaciones existentes use [docs/UPGRADE.md](docs/UPGRADE.md).
...
Configure `/etc/coferlandia-ci-watchdog.env`, incluyendo `GITHUB_MONITOR_TOKEN` si desea monitoreo remoto y self-healing. La política y parámetros están documentados en [docs/MONITORING.md](docs/MONITORING.md).
